...
<head>
    ...
    <meta nam="description" content"<p>
    Welcome to Tuatuagye, your one stop online store. Shop items and pay in installment. Buy phones, 44 digital TV, freezer, blender, kettle etc. </p>">
   ...
   // exit();
    ...
    $output .= ' 
                    ...
                    <div class="product-item">
                        <div class="pi-pic">
                          <img src="http://tuatuagye.com/upload/image/'.$row["image"].'" alt="">
                            <div class="icon">
   ...
   <script>
    ...
    $(function () {
                        ...
                        $('a.buy-item').click(function (e) { 
                            ...
                            */
                             ?>
    window.location = "http://tuatuagye.com/test/cart.php?product_id= "+ id;
