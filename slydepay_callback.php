...
$pay = new IwalletConnector(
    $payLIVE['iwalletAPI']['ns'],
    $payLIVE['iwalletAPI']['servUri'],
    $payLIVE['iwalletAPI']['apiVersion'],
    $payLIVE['iwalletAPI']['merchantEmail'],
    $payLIVE['iwalletAPI']['merchantKey'],
    $payLIVE['iwalletAPI']['serviceType'],
    $payLIVE['iwalletAPI']['intMode']
);
...
echo "<br>";
echo "<h2> confirm : </h2>";
echo "<h2> $confirm->ConfirmTransactionResult </h2>";
echo "<br>";echo "<br>";
        ...
        echo '<br>';
        echo 'confirm transaction stauts  .. <br>';
        echo $confirm->ConfirmTransactionResult;
/*
switch ($status) {
    case "0":  //for success
